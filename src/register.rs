use windows::{Win32::{Foundation::HINSTANCE, System::Com::{CLSCTX_INPROC_SERVER, CoCreateInstance}, UI::TextServices::{CLSID_TF_InputProcessorProfiles, ITfInputProcessorProfiles}}, core::{GUID, Interface}};
